...
def main():
    ...
    write_json(rows, DEFAULT_CONFIG.normalized_json_output)
    write_csv(rows, DEFAULT_CONFIG.normalized_csv_output)
    write_diagnostics(diagnostics, DEFAULT_CONFIG.normalized_run_summary_output)
    ...
    print(f"JSON output: {DEFAULT_CONFIG.normalized_json_output}")
    print(f"CSV output: {DEFAULT_CONFIG.normalized_csv_output}")
    print(f"Run summary: {DEFAULT_CONFIG.normalized_run_summary_output}")
